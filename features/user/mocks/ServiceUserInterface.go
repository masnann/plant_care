...
func (_m *ServiceUserInterface) GetAllUsers() ([]*domain.UserModel, error) {
	ret := _m.Called()
...
func (_m *ServiceUserInterface) GetUserByEmail(email string) (*domain.UserModel, error) {
	ret := _m.Called(email)
...
func (_m *ServiceUserInterface) GetUserById(userId uint64) (*domain.UserModel, error) {
